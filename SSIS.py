...
class Student:
    ...
    def __init__ (self,root):
        ...
        def iExit():
            iExit = tkinter.messagebox.askyesno("MSU-IIT SIS","Are you sure you want to EXIT?")
            if iExit > 0:
                root.destroy()
                return
        ...
        ManageFrame=Frame(self.root, bd=5, relief =RIDGE, bg="Darksalmon")
        ManageFrame.place(x=870, y=260,width=470, height=400)

        title=Label(self.root, text = "MSU-IIT STUDENT INFORMATION SYSTEM",bd=4,relief=RIDGE, font=("Source code",40,"bold"),bg="Darksalmon", fg="Firebrick")
        title.pack(side=TOP)
        
        DetailFrame=Frame(self.root, bd=4, relief =RIDGE, bg="Darksalmon")
        DetailFrame.place(x=20, y=100,width=830, height=560)

        ButtonFrame=Frame(self.root, bd=4, bg="Darksalmon", relief = RIDGE)
        ButtonFrame.place(x=870,y=100, width=470, height=140)
        
        #============================================================LABELS AND ENTRY WIDGETS====================================================#

        title=Label(ManageFrame, text="STUDENT INFORMATION",bg="Darksalmon", fg="Firebrick", font=("Source code",20,"bold"))
        title.grid(row=0, columnspan=2, pady=20)
        
        self.lblStdID = Label(ManageFrame, font=("Source code",15,"bold"),text="ID Number:", padx=2, pady=2, bg="Firebrick", fg="white",  height=1, width=11)
        self.lblStdID.grid(row=1, column=0,padx=5,pady=5)
        self.txtStdID = Entry(ManageFrame, font=("Source code",15,"bold"),textvariable=StudID, relief=GROOVE, width=27, fg="Firebrick")
        self.txtStdID.grid(row=1, column=1)
        self.txtStdID.place(x=150,y=85)

        self.lblFirstname = Label(ManageFrame,font=("Source code",15,"bold"),text="Last Name:", padx=2, pady=2, bg="Firebrick", fg="white", height=1, width=11)
        self.lblFirstname.grid(row=2, column=0,padx=5,pady=5, sticky="w")        
        self.txtFirstname = Entry(ManageFrame, font=("Source code",15,"bold"),textvariable=LastName, relief=GROOVE,width=27, fg="Firebrick")
        self.txtFirstname.grid(row=2, column=1)
        self.txtFirstname.place(x=150,y=127)
        
        self.lblMidname = Label(ManageFrame, font=("Source code",15,"bold"),text="First Name:", padx=2, pady=2, bg="Firebrick", fg="white", height=1, width=11)
        self.lblMidname.grid(row=3, column=0,padx=5,pady=5, sticky="w")
        self.txtMidname = Entry(ManageFrame, font=("Source code",15,"bold"),textvariable=FirstName, relief=GROOVE,width=27, fg="Firebrick")
        self.txtMidname.grid(row=3, column=1)
        self.txtMidname.place(x=150,y=169)

        self.lblSurname = Label(ManageFrame, font=("Source code",15,"bold"),text="Middle Name:", padx=2, pady=2, bg="Firebrick", fg="white", height=1, width=11)
        self.lblSurname.grid(row=4, column=0,padx=5,pady=5, sticky="w")
        self.txtSurname = Entry(ManageFrame, font=("Source code",15,"bold"),textvariable=MiddleName, relief=GROOVE,width=27, fg="Firebrick")
        self.txtSurname.grid(row=4, column=1)
        self.txtSurname.place(x=150,y=211)

        self.lblYearlevel = Label(ManageFrame, font=("Source code",15,"bold"),text="Year Level:", padx=2, pady=2, bg="Firebrick", fg="white", height=1, width=11)
        self.lblYearlevel.grid(row=5, column=0,padx=5,pady=5, sticky="w")
        ttk.Style().layout('combostyleO.TCombobox')
        ttk.Style().configure('combostyleO.TCombobox', selectforeground='Firebrick', selectbackground='grey',  foreground='Firebrick')
        ...
        self.lblGender = Label(ManageFrame, font=("Source code",15,"bold"),text="Gender:", padx=2, pady=2, bg="Firebrick", fg="white", height=1, width=11)
        ...
        self.lblCourse = Label(ManageFrame, font=("Source code",15,"bold"),text="Course:", padx=2, pady=2, bg="Firebrick", fg="white", height=1, width=11)
        self.lblCourse.grid(row=7, column=0,padx=5,pady=5, sticky="w")
        self.txtCourse = Entry(ManageFrame, font=("Source code",15,"bold"),textvariable=Course, relief=GROOVE,width=27, fg="Firebrick")
        ...
        self.lblSearch = Button(DetailFrame, font=('Source code',15,'bold'),text="Search by ID:", padx=2, pady=2, bg="Firebrick", fg="white", height=1, width=12)
        self.lblSearch.grid(row=1, column=0,padx=2,pady=2, sticky="w")
        self.lblSearch.place(x=50,y=480)
        
        self.Search = Entry(DetailFrame, font=('Source code',15,'normal'),textvariable=Searchbar, relief=GROOVE, width=25, fg = "Firebrick")
        self.Search.grid(row=1, column=1)
        self.Search.place(x=220,y=488)

        self.btnSearch = Button(DetailFrame, text="Search",font=("Source code",12,"bold"),bg="Firebrick", fg="white", height=1, width=12, bd=4, command=searchStd)
        self.btnSearch.grid(row=1, column=2,padx=15, pady=15)
        self.btnSearch.place(x=520,y=480)
        
        self.btnDisplayData = Button(DetailFrame, text="Select", font=("Source code",12,"bold"),bg="Firebrick", fg="white", height=1, width=12, bd=4,command=editStd)
        self.btnDisplayData.grid(row=1, column=3, padx=15, pady=15)
        self.btnDisplayData.place(x=670,y=480)
        
        TableFrame=Frame(DetailFrame, bd=4,relief=RIDGE,bg='Darksalmon')
        TableFrame.place(x=10,y=10, width=790, height=450)
        ...
        tree['show'] = 'headings'
        style = ttk.Style()
        style.configure("Treeview.Heading", font=("Source code",14,"bold"),foreground="Firebrick")
        style.configure("Treeview",font=("Source code",12,"normal"))
        style.map('Treeview', background=[('selected', 'grey')], foreground=[('selected', 'Firebrick')])
